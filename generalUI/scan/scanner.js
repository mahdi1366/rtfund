!function(global,definition){
	...
	var scannerDef={
		...
		scanAppDownloadUrl:"/GeneralUI/scan/scan-setup.exe",
		...
		failedToConnectToWebSocketServer:function(){
			...
			/*if(!this.doesCurrentBrowserSupportNPAPI()){this.displayInstallScanAppEnableJavaPopup(true);}*/
		...
		connectToScanWebSocketServer:function(inTheSameAttempt){
			...
			this.createWebSocket(host+":"+this.scanWebSocketServerPort+"/"+this.getPageSessionId()+"/"+
				encodeURIComponent(this.removeFragmentFromUrl(window.location.href)),this.onScanWebSocketOpen,
				this.onScanWebSocketClose,this.onScanWebSocketMesg,undefined);
		},
		...
		addInstallPromptDomElementIfNotExists:function(){
			...
			var divPromptModel={
				...
				/*{"name":"h3","attributes":{"style":"margin-top: 0px;","text":"Please Enable Scanning"}},*/

				{
					...
					/*{"name":"p","attributes":{"text":"In order to scan directly from your browser, you need to either enable Java or install the scan app: "}},*/

					{
						...
						"children":[/*{"name":"td","attributes":
			{"width":"50%","align":"center","valign":"top"},"children":[{"name":"h4","attributes":
			{"text":"Either Option 1:"}},{"name":"a","attributes":{"class":"icon-action icon-action-enable-java",
			"href":"javascript:scanner.displayEnableJavaHelp();"}},{"name":"p","attributes":
			{"style":"vertical-align: middle; text-align: center;"},"children":[{"name":"a","attributes":
			{"href":"javascript:scanner.displayEnableJavaHelp();","text":"Enable Java"}},{"name":"span",
			"attributes":{"text":"; once done, please "}},{"name":"button","attributes":{"type":"button",
			"class":"btn btn-default btn-xs","onclick":"document.location.reload(false);","style":"",
			"text":"Refresh Page"}}]},]},{"name":"td","attributes":{"width":"10px"}},{"name":"td","attributes":{
			"width":"1px","style":"background-color: #cccccc;"}},{"name":"td","attributes":{"width":"10px"}},*/
			...
			{"text":"Or Option 2:"}},*/ {
							...
							}/*,{"name":"p","children":[{"name":"a","attributes":{
			"href":urlAppDownload,"target":"_blank","text":"Download and run it"}},
			{"name":"span","attributes":{"text":". No need to refresh page."}}]}*/]
				...
				},
				{
					...
					/*{"name":"p","attributes":{"text":"In order to scan directly from your browser, you need to install the scan app: "}},*/
					...
					/*,{"name":"p","attributes":{"style":"vertical-align: middle; text-align: center;"},"children":[{"name":"a","attributes":{"href":urlAppDownload,"target":"_blank","text":"Download and run it"}},{"name":"span","attributes":{"text":". No need to refresh page."}}]}*/]
				}]
			};
			var divOverlayModel={
				"name":"div",
			...
			var o={
				...
				getJPIVersionUsingMimeType:function(){
					for(var e=0;e<navigator.mimeTypes.length;++e){
						var t=navigator.mimeTypes[e].type,n=t.match(/^application\/x-java-applet;jpi-version=(.*)$/);
