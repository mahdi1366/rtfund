<html>
  ...
  <body onkeydown="pressing(event);" onload="return BodyLoad();">
    ...
    <div class="login">
		<div style="color: white; font-family: tahoma; font-size: 14px; font-weight: bold; text-align: center; line-height: 30px; padding-bottom: 30px;">
			ورود به سیستم
		<br></div>
		<form method="post" id="MainForm" onsubmit="return loginFN();">
			...
			<button type="submit" class="btn btn-primary btn-block btn-large ">ورود به سیستم</button>
		</form>
	</div>
  </body>
</html>