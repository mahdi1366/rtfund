...
INSERT INTO `ACC_tafsilis` (`TafsiliID`,`TafsiliCode`,`TafsiliType`,`TafsiliDesc`,`BranchID`,`IsActive`) VALUES 
 (1,'1000',1,'شرکت ی111',1,'YES'),
 (2,'1001',1,'شرکت 2',1,'YES'),
 (3,'1',2,'شخص 1',1,'YES');
...
--
-- Definition of table `BSC_peoples`
--

DROP TABLE IF EXISTS `BSC_peoples`;
CREATE TABLE `BSC_peoples` (
  `PeopleID` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'کد فرد',
  `UserName` varchar(100) NOT NULL COMMENT 'کلمه کاربری',
  `UserPass` varchar(60) NOT NULL COMMENT 'رمز عبور',
  `fullname` varchar(500) NOT NULL COMMENT 'عنوان',
  `NationalID` decimal(10,0) DEFAULT NULL COMMENT 'کد ملی',
  `EconomicID` decimal(10,0) DEFAULT NULL COMMENT 'کد اقتصادی',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='ذینفعان';

--
-- Dumping data for table `BSC_peoples`
--

/*!40000 ALTER TABLE `BSC_peoples` DISABLE KEYS */;
INSERT INTO `BSC_peoples` (`PeopleID`,`UserName`,`UserPass`,`fullname`,`NationalID`,`EconomicID`,`PhoneNo`,`mobile`,`address`,`email`,`IsBorrow`,`IsShareholder`,`IsActive`) VALUES 
 (1,'admin','$P$B8EFk1xg.sI1HQghqLPJ8Fv/uCtmLw0','شبنم جعفرخانی',NULL,NULL,NULL,NULL,NULL,NULL,'NO','NO','YES');
/*!40000 ALTER TABLE `BSC_peoples` ENABLE KEYS */;
...
) ENGINE=MyISAM AUTO_INCREMENT=459 DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci COMMENT='اطلاعات ممیزی ';
...
INSERT INTO `FRW_menus` (`SystemID`,`MenuID`,`ParentID`,`MenuDesc`,`IsActive`,`ordering`,`icon`,`MenuPath`,`IsBorrow`,`IsShareholder`) VALUES 
 (1,1,0,'مدیریت  سیستم ها','YES',1,NULL,NULL,'NO','NO'),
 (1,2,0,'مدیریت کاربران','YES',2,NULL,NULL,'NO','NO'),
 (1,3,1,'مدیریت سیستم ها','YES',1,NULL,'management/systems.php','NO','NO'),
 (1,4,1,'مدیریت منوها','YES',2,NULL,'management/menus.php','NO','NO'),
 (1,5,2,'دسترسی کاربران','YES',2,'access.gif','management/UserAccess.php','NO','NO'),
 (1,6,2,'کاربران','YES',1,'users.gif','management/users.php','NO','NO'),
 (2,7,0,'اطلاعات پایه','YES',1,NULL,NULL,'NO','NO'),
 (2,8,7,'مدیریت کد حساب','YES',3,NULL,'baseinfo/CostCodes.php','NO','NO'),
 (1,9,0,'اطلاعات پایه','YES',3,NULL,NULL,'NO','NO'),
 (1,10,9,'واحدهای سازمان','YES',1,'unit.png','baeinfo/units.php','NO','NO'),
 (1,11,9,'مدیریت شعب','YES',2,NULL,'baseinfo/branches.php','NO','NO'),
 (1,12,9,'دسترسی شعب','YES',3,NULL,'baseInfo/BranchAccess.php','NO','NO'),
 (6,13,0,'اطلاعات پایه','YES',NULL,NULL,NULL,'NO','NO'),
 (6,14,13,'انواع وام','YES',1,NULL,'loan/loans.php','NO','NO'),
 (6,15,0,'اعطای تسهیلات','YES',NULL,NULL,NULL,'NO','NO'),
 (6,16,15,'مدیریت درخواست ها','YES',1,NULL,'request/requsts.php','NO','NO'),
 (6,17,0,'گزارشات','YES',NULL,NULL,NULL,'NO','NO'),
 (6,18,17,'گزارش درخواست های تسهیلات','YES',1,NULL,'report/requests.php','NO','NO'),
 (2,19,0,'گزارشات','YES',3,NULL,NULL,'NO','NO'),
 (2,21,0,'عملیات برگه','YES',2,NULL,NULL,'NO','NO'),
 (2,22,21,'مدیریت برگه ها','YES',1,NULL,'docs/docs.php','NO','NO'),
 (2,23,21,'سند افتتاحیه / اختتامیه','YES',2,NULL,'docs/CloseOpenDocs.php','NO','NO'),
 (2,25,7,'مدیریت تفصیلی ها','YES',4,NULL,'baseinfo/tafsilis.php','NO','NO'),
 (2,26,19,'گزارش تراز','YES',1,NULL,'report/taraz.php','NO','NO'),
 (2,27,19,'گزارش گردش حساب','YES',2,NULL,'report/flow.php','NO','NO'),
 (2,28,19,'گزارش اسناد','YES',3,NULL,'report/docs.php','NO','NO'),
 (4,29,0,'اطلاعات پایه','YES',1,NULL,NULL,'NO','NO'),
 (4,30,29,'نامه های رسیده','YES',2,NULL,'letter/receive.php','NO','NO'),
 (4,31,29,'ایجاد نامه','YES',1,NULL,'letter/newLetter.php','NO','NO'),
 (4,32,29,'نامه های ارسالی','YES',3,NULL,'letter/send.php','NO','NO'),
 (2,34,7,'اجزای حساب','YES',2,NULL,'baseinfo/blocks.php','NO','NO'),
 (2,36,7,'حساب های بانکی','YES',5,NULL,'baseinfo/accounts.php','NO','NO'),
 (4,37,0,'فرمساز','YES',4,NULL,NULL,'NO','NO'),
 (4,38,37,'مدیریت فرم ها','YES',1,NULL,'formGenerator/buildForm.php','NO','NO'),
 (1000,39,0,'وام گیرنده','YES',2,NULL,NULL,'YES','NO'),
 (1000,40,0,'سهامداران','YES',1,NULL,NULL,'NO','YES'),
 (1000,41,39,'درخواست وام','YES',1,'clone','loan/test.php','YES','NO'),
 (1000,42,39,'مدیریت وام های دریافتی','YES',2,'list','/','YES','NO'),
 (1000,43,39,'پرداخت اقساط','YES',3,'credit-card','/','YES','NO'),
 (1000,44,40,'مدیریت سهام','YES',1,'database','/','NO','YES');
...
INSERT INTO `FRW_persons` (`PersonID`,`UserID`,`UserPass`,`fname`,`lname`,`IsActive`,`PostID`) VALUES 
 (1000,'admin','$P$B8EFk1xg.sI1HQghqLPJ8Fv/uCtmLw0','شبنم','جعفرخانی','YES',1),
 (1001,'mahdipour',NULL,'بهاره','مهدی پور','YES',2);
...
INSERT INTO `LON_loans` (`LoanID`,`GroupID`,`LoanDesc`,`MaxAmount`,`CostusCount`,`CostusInterval`,`DelayCount`,`InsureAmount`,`FirstCostusAmount`,`ForfeitPercent`,`FeePercent`,`FeeAmount`,`ProfitPercent`) VALUES 
 (1,1,'وام طرح های بزرگ','120000000',36,30,365,'1200000','1200000',10,10,'20000',20),
