...
CREATE TABLE `ACC_DocChecks` (
  ...
  PRIMARY KEY  USING BTREE (`CheckID`),
...
CREATE TABLE `ACC_blocks` (
  ...
  `IsActive` enum('YES','NO') NOT NULL,
  PRIMARY KEY  USING BTREE (`BlockID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `BaseInfo` (
  ...
  PRIMARY KEY  USING BTREE (`InfoID`,`TypeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=432 DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci COMMENT='اطلاعات ممیزی ';
...
CREATE TABLE `FGR_forms` (
  ...
  `reference` varchar(45) NOT NULL COMMENT 'آیتم',
  PRIMARY KEY  (`FormID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Definition of table `FRG_FormElements`
--

DROP TABLE IF EXISTS `FRG_FormElements`;
CREATE TABLE `FRG_FormElements` (
  `ElementID` int(10) unsigned NOT NULL auto_increment,
  `FormID` int(10) unsigned NOT NULL,
  `ElementTitle` varchar(200) NOT NULL,
  `ElementType` varchar(100) NOT NULL,
  `ElementValue` varchar(500) default NULL,
  `RefField` varchar(100) default NULL,
  `RefDesc` varchar(100) default NULL,
  `RefInfoID` varchar(45) default NULL,
...
--
-- Dumping data for table `FRG_FormElements`
--

/*!40000 ALTER TABLE `FRG_FormElements` DISABLE KEYS */;
/*!40000 ALTER TABLE `FRG_FormElements` ENABLE KEYS */;
...
INSERT INTO `FRW_menus` (`SystemID`,`MenuID`,`ParentID`,`MenuDesc`,`IsActive`,`ordering`,`icon`,`MenuPath`) VALUES 
 ...
 (2,7,0,'اطلاعات پایه','YES',1,NULL,NULL),
 (2,8,7,'مدیریت کد حساب','YES',3,NULL,'baseinfo/CostCodes.php'),
 (1,9,0,'اطلاعات پایه','YES',3,NULL,NULL),
 (1,10,9,'واحدهای سازمان','YES',1,'unit.png','baeinfo/units.php'),
 (1,11,9,'مدیریت شعب','YES',2,NULL,'baseinfo/branches.php'),
 (1,12,9,'دسترسی شعب','YES',3,NULL,'baseInfo/BranchAccess.php'),
 (6,13,0,'اطلاعات پایه','YES',NULL,NULL,NULL),
 (6,14,13,'انواع وام','YES',1,NULL,'loan/loans.php'),
 (6,15,0,'اعطای تسهیلات','YES',NULL,NULL,NULL),
 (6,16,15,'مدیریت درخواست ها','YES',1,NULL,'request/requsts.php'),
 (6,17,0,'گزارشات','YES',NULL,NULL,NULL),
 (6,18,17,'گزارش درخواست های تسهیلات','YES',1,NULL,'report/requests.php'),
 (2,19,0,'گزارشات','YES',3,NULL,NULL),
 (2,21,0,'عملیات برگه','YES',2,NULL,NULL),
 (2,22,21,'مدیریت برگه ها','YES',1,NULL,'docs/docs.php'),
 (2,23,21,'سند افتتاحیه / اختتامیه','YES',2,NULL,'docs/CloseOpenDocs.php'),
 (2,25,7,'مدیریت تفصیلی ها','YES',4,NULL,'baseinfo/tafsilis.php'),
 (2,26,19,'گزارش تراز','YES',1,NULL,'report/taraz.php'),
 (2,27,19,'گزارش گردش حساب','YES',2,NULL,'report/flow.php'),
 (2,28,19,'گزارش اسناد','YES',3,NULL,'report/docs.php'),
 (4,29,0,'اطلاعات پایه','YES',1,NULL,NULL),
 (4,30,29,'نامه های رسیده','YES',2,NULL,'letter/receive.php'),
 (4,31,29,'ایجاد نامه','YES',1,NULL,'letter/newLetter.php'),
 (4,32,29,'نامه های ارسالی','YES',3,NULL,'letter/send.php'),
 (2,34,7,'اجزای حساب','YES',2,NULL,'baseinfo/blocks.php'),
 (2,36,7,'حساب های بانکی','YES',5,NULL,'baseinfo/accounts.php');
