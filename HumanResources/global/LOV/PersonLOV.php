...
<html>
	...
	Ext.onReady(function(){ 	
		...
		new Ext.KeyMap("searchPersonPNL", [{key:Ext.EventObject.ENTER, fn:searching}]);
	});
...
$col = $dg->addColumn(" شماره پرسنلی","PersonID","int");
...
<script>
   ...
   <center>
	<form id="search">
		...
		<table width="100%" id="searchPersonPNL">
			<tr>
				<td>نام :</td>
			...
			<tr>
				...
				<td><input type="text" name="from_PersonID" class="x-form-text x-form-field"></td>
				<td>تا :</td>
				<td><input type="text" name="to_PersonID" class="x-form-text x-form-field"></td>
			</tr>
			<tr>
				<td>عنوان واحد :</td>
