...
//	echo   PdoDataAccess::GetLatestQueryString() ; 		die()			 ; 
	...
	$query = "	select 
				...
				order by pay_year,pay_month,daily_work_place_no,plname,pfname  limit 1 
                                 " ; 
...
die();*/ 
	...
	if( $_REQUEST["task"] == 'GetDisk' ) {		
		...
		if($res[$i]['sex'] == 1 )
			...
			else $contract_start_date = '1397/01/01';
