...
TrafficReq.prototype.DeleteGroup = function(GroupID)
{
	Ext.MessageBox.confirm("","آیا مایل به حذف می باشید؟", function(btn){
		...
		Ext.Ajax.request({
			url: me.address_prefix + 'TrafficReq.data.php',
			params:{
				task: "DeleteGroup",
				GroupID : GroupID
			},
			...
			success: function(response,option){
				...
				if(sd.success)
				{
					TrafficReqObject.groupPnl.down('[name=GroupID]').setValue();
					TrafficReqObject.groupPnl.down('[name=GroupID]').getStore().load();
					TrafficReqObject.grid.hide();
				}	
				else
				{
