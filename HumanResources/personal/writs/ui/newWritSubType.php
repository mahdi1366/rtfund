...
<table width="100%">
	<tr>
		...
		<td width="80%" height="21px" colspan="3"><b><?= $_POST["WT_title"] ?></b></td>
	</tr>
    ...
    <tr>
		...
		امکان صدور حکم براي افراد غير شاغل؟
         &nbsp;<input type="checkbox" value="1" id="force_writ_issue"  name="force_writ_issue" 
		                      class="x-form-text x-form-field" style="width: 10px"  <?= ($obj->force_writ_issue == "1") ? "checked" : ""?> >
		</td>
	</tr> 
    <tr>
		<td width="20%" colspan="4">
	...
	<tr><td colspan="4" align="center">
			<input type="button" value="ذخیره" onclick="WritTypeObject.saveWritSubType();" class="button">
			<input type="button" value="انصراف" id="btn_cancel_subWritType" onclick="WritTypeObject.WritSubTypePanel.hide();" class="button"></td></tr>
</table>