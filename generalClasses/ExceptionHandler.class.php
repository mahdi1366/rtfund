...
class ExceptionHandler
{
	 ...
	 * @return
	 */
	static public function PushException($Description, $exceptionType = ExceptionHandler::ExceptionType_error)
	{
...
//		print_r(debug_backtrace());
	 ...
	 * @return pushed type
	 */
	static public function PopException()
	{
		if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
	 ...
	 * @return pushed type
	 */
	static public function popExceptionDescription()
	{
		 if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
	...
	*/
	static public function PopAllExceptions()
	{
		if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
	...
	*/
	static public function GetExceptionCount()
	{
		if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
	...
	*/
	 ...
	 * @return <type>
	 */
	static public function showExceptionPanel($elementID,$include_errors = true, $include_warnings = true, $include_messages = true)
	{
		if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
	...
	static function ConvertExceptionsToJsObject($include_errors = true, $include_warnings = true, $include_messages = true)
	{
		if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
	...
	static function SaveExceptionsToSession($sessionName)
	{
		if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
	...
	static function RestoreExceptionsFromSession($sessionName)
	{
		if(isset($this) && isset($this->exceptions))
			$exceptionArray = & $this->exceptions;
		else
