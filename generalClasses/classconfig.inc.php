...
define("inc_dataGrid", "grid.class.php");
define("inc_dataReader", "dataReader.class.php");
define("inc_component","component.class.php");
define("inc_response", "response.class.php");

define("inc_UserRole", getenv("DOCUMENT_ROOT") . "/framework_management/UserRole/UserRole.class.php");
?>
